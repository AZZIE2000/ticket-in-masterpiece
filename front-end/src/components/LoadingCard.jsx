        ...
        <Tabs className='flex animate-pulse flex-col items-center mt-5  ' >
            ...
            <div className='flex gap-y-9 w-full lg:w-3/4 mt-3 container mx-auto flex-col'>
                <article
                    ...
                    class="md:flex animate-pulse shadow-md shadow-gray-900/10 bg-white transition hover:shadow-xl dark:bg-gray-800 dark:shadow-gray-800/25"
                >
                    ...
                    <div class="  lg:basis-96   sm:block  basis-56">
                        <div class="object-cover lg:object-scale-down h-full    w-full bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
                        </div>
                    ...
                    <div class="flex flex-1  flex-col justify-between">
                        ...
                        <div class="sm:flex sm:items-end sm:justify-end">
                            ...
                            <span
                                class="block bg-gray-200 px-5 py-3 text-center text-xs font-bold uppercase text-white dark:bg-gray-700 "
                            >
                                Buy
                            </span>
                        </div>
