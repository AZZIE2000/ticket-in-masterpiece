                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="bg-gray-50 py-12 md:py-24">
                            <div className="mx-auto max-w-lg px-4 lg:px-8">
                                ...
                                <div className="mt-8">
                                    <p className="text-2xl font-medium tracking-tight">100.15 JD</p>
                                        ...
                                        <ul className="-my-4 divide-y divide-gray-200">
                                            <li className="flex items-center justify-between py-4">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ml-4">
                                                        <p className="text-sm">Concert Name</p>

                                                        <dl className="mt-1 space-y-1 text-xs text-gray-500">
                                                            <div>
                                                                <dt className="inline">ClassName:</dt>
                                                                <dd className="inline"> VIP</dd>
                                                            </div>

                                                            <div>
                                                                <dt className="inline">Extra: </dt>
                                                                <dd className="inline">any extra info if existed </dd>
                                                            </div>
                                                        </dl>
                                                    </div>
                                                </div>
                        ...
                        <div className="bg-white py-12 md:py-24">
                            <h2 className="font-medium text-center relative -translate-y-4">We Got You DW About Your Account</h2>
                            <div className="mx-auto max-w-lg px-4 lg:px-8">
