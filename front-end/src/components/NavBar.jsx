            ...
            <div className="relative grid items-center grid-cols-2 lg:grid-cols-3 z-50">
                ...
                <ul className=" items-center hidden ml-auto space-x-8 lg:flex">
                    ...
                    <li>
                        ...
                        <a
                            href="/"
                            className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-candy hover:bg-blue focus:shadow-outline focus:outline-none"
                            aria-label="Sign up"
                            title="Sign up"
                        >
                            Sign up
