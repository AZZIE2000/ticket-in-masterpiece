        ...
        <>
            <section class="bg-white dark:bg-gray-900 ">
                <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
                    <section
                        class=" relative flex h-32 items-end bg-white dark:bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6"
                    >
                        <img
                            style={{ clipPath: "ellipse(78% 77% at 21% 69%)" }}
                            alt="Night"
                            src="https://www.numeromag.nl/wp-content/uploads/2022/05/thumbnail_SUNDAY-min.jpeg"
                            class="absolute inset-0 h-full w-full object-cover opacity-80 lg:block hidden "
                        />
